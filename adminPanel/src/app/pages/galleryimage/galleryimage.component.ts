...
import { GalleryService } from '../../services/galleryimage.service';
...
@Component({
  ...
  styleUrls: ['./galleryimage.component.scss']
})
export class GalleryimageComponent implements OnInit {
  ...
  currentUser :  any;
  _albums : any=[];
  constructor(private _formBuilder: FormBuilder,private _lightbox: Lightbox ,private toastr: ToastrService,private   galleyservice :GalleryService) { }
