...
class Skills extends REST_Controller {	
	...
	public function index_post(){
		...
		$Insert_Array = array(
			"`user_id`" => $this->post('user_id'),
			"`skillsarray`" => $this->post('insertArray')
		);
		...
		if(true){
			...
			if($token_status == TRUE){
				$Check_Availability_Result = $this->Skills_modal->Check_Skills_Availability($user_id);
				if($Check_Availability_Result){
					$Insert_saveUser_Result = $this->Skills_modal->Update_Skills($Insert_Array,$user_id);
					...
					$Insert_saveUser_Result = $this->Skills_modal->Insert_Skills($Insert_Array,$user_id);
	...
	public function getSkills_post(){
		...
		$token_status = check_token($user_id,$headers['Authorization']);
		if($token_status == TRUE){
			$Check_Availability_Result = $this->Skills_modal->workSkillsData($user_id);
			if($Check_Availability_Result){
